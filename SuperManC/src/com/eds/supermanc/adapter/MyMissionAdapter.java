...
public class MyMissionAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.mLinearSongcandate = (LinearLayout) convertView.findViewById(R.id.linear_songcandate);
        ...
        if (mb.getStatus() == 1 || mb.getStatus() == 3) {
            holder.mLinearSongcandate.setVisibility(View.GONE);
        } else {
            if (iOrderType == 1) {
                holder.mLinearSongcandate.setVisibility(View.VISIBLE);
    ...
    private class Holder {
        ...
        private LinearLayout mLinearSongcandate;
