...
public class MissionDetailActivity extends BaseActivity implements HTTPListener, OnClickListener {
    ...
    private TextView tvSongcandate;
    ...
    private void initView() {
        ...
        songcandateLayout = (LinearLayout) findViewById(R.id.linear_songcandate);
        tvSongcandate = (TextView) findViewById(R.id.tv_songcandate);
        initTitle();
    }
    ...
    private void changeUI() {
        ...
        if (mission.getStatus() == 1 || mission.getStatus() == 3) {
            songcandateLayout.setVisibility(View.GONE);
        } else {
            int iOrderType = mission.getOrderType();
            if (iOrderType == 1) {
                songcandateLayout.setVisibility(View.VISIBLE);
                tvSongcandate.setText(mission.getSongCanDate());
            } else {
                songcandateLayout.setVisibility(View.GONE);
            }
        }
