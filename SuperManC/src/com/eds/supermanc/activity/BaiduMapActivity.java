...
public class BaiduMapActivity extends BaseActivity implements BaiduMap.OnMapClickListener, OnGetRoutePlanResultListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (this.getIntent() != null && this.getIntent().getExtras().containsKey("city")
                && this.getIntent().getExtras().containsKey("detailAddress")) {
    ...
    public void SearchButtonProcess(View v) {
        ...
        PlanNode enNode = PlanNode.withCityNameAndPlaceName(/* "北京" */endCity, /* editEn.getText().toString() */
                endDetailAddress/* "朝阳区下甸甲3号院尚8国际广告园" */);
        ...
        if (v.getId() == R.id.drive) {
            ...
            mSearch.transitSearch((new TransitRoutePlanOption()).from(stNode).city(/* ("北京" */startCity).to(enNode));
    ...
    private class MyDrivingRouteOverlay extends DrivingRouteOverlay {
        ...
        public BitmapDescriptor getStartMarker() {
            if (useDefaultIcon) {
                return BitmapDescriptorFactory.fromResource(R.drawable.map_map_start);
            }
            return null;
        }
        ...
        public BitmapDescriptor getTerminalMarker() {
            if (useDefaultIcon) {
                return BitmapDescriptorFactory.fromResource(R.drawable.map_map_end);
            }
            return null;
        }
    }
